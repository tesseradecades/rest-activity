...
{
  $person_info = file_get_contents('http://www.se.rit.edu/~nwe8978/swen-344/rest-activity/RESTAPI.php?action=get_person&id=' . $_GET["id"]);
  ...
  ?>
    ...
    <a href="http://www.se.rit.edu/~nwe8978/swen-344/rest-activity/RestClient.php?action=get_person_list" alt="person list">Return to the person list</a>
  <?php
}
else // else take the person list
{
  // Create the person list
  $person_list = file_get_contents('http://www.se.rit.edu/~nwe8978/swen-344/rest-activity/RESTAPI.php?action=get_person_list');
  ...
  ?>
    ...
    <?php foreach ($person_list as $person): ?>
      <li>
        ...
        <a href=<?php echo "http://www.se.rit.edu/~nwe8978/swen-344/rest-activity/RestClient.php?action=get_person&id=" . $person["id"]  ?> alt=<?php echo "person_" . $person_["id"] ?>><?php echo $person["name"] ?></a>
    </li>
    <?php endforeach; ?>
    </ul>
  <?php
